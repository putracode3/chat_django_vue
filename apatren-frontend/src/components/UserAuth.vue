<template>
  <div class="container">
    <h1 class="text-center">Welcome to Apatren!</h1>
        ...
        <div class="tab-content" id="myTabContent">
          ...
          <div class="tab-pane fade" id="signin" role="tabpanel" aria-labelledby="signin-tab">
            <form @submit.prevent="signIn">
              <div class="form-group">
                <input v-model="username" type="text" class="form-control" id="username_i" placeholder="Username" required>
              </div>
              <div class="form-group">
                <input v-model="password" type="password" class="form-control" id="password_i" placeholder="Password" required>
              </div>
